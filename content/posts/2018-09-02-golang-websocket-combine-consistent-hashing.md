...
<img class="aligncenter" src="https://leileiluoluo.com/wp-content/uploads/2018/09/comet-api.png" alt="" width="664" height="261" />
  
为使前端的接入更简单，从建立连接到用户关闭浏览器，中间前端无须发送消息来告知服务器client是否下线。我们将检测放在后台，后台采用定时心跳方式保持对client的监听，若心跳失败，则将该client剔除。如下图所示。
  
<img class="aligncenter" src="https://leileiluoluo.com/wp-content/uploads/2018/09/comet-heartbeat.png" alt="" width="408" height="220" />
