...
前面两篇文章「[如何使用 Spring Boot 和 Kotlin 构建 RESTful API 服务？](https://leileiluoluo.github.io/posts/building-restful-api-with-spring-boot-and-kotlin.html)」、「[如何使用 Kotlin HTTP 工具包 http4k 构建 RESTful API 服务？](https://leileiluoluo.github.io/posts/building-restful-api-with-http4k.html)」分别介绍了 Kotlin 使用 Spring Boot，以及 Kotlin 使用 http4k 开发 RESTful API 的方法。本文则关注如何使用 Kotlin 官方主推的 Web 框架 Ktor 来开发 RESTful API？
...
本文整个示例项目的代码已托管至本人 [GitHub](https://github.com/leileiluoluo/kotlin-exercises/tree/main/ktor-restful-service-demo)，欢迎关注或 Fork。
