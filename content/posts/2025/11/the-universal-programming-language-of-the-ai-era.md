...
综上，这么看下来，在 AI 时代，开发者可能会从之前的专注于代码实现上解脱出来，而会将时间更多的放在设计、架构和编写规范文档上。而良好的规范会帮助 AI 消除歧义、减少幻觉，从而实现准确可靠的代码。「规范驱动开发」这种新的实践方式目前在业界还属于探索和发展中，开发者以后是否可以彻底告别编写代码，而将日常工作完全放在编写诸如 Markdown 等规范文档上，相信不远的将来即会有答案。
